...
def lipa_na_mpesa_online(request,pk):
    ...
    request = {
        ...
        "PartyA": booking.mobile_no,  # replace with your phone number to get stk push
        "PartyB": LipanaMpesaPpassword.Business_short_code,
        "PhoneNumber": booking.mobile_no,  # replace with your phone number to get stk push
        "CallBackURL": "https://sandbox.safaricom.co.ke/mpesa/",
        "AccountReference": "Pochii",
        "TransactionDesc": "Testing stk push"
    }
    response = requests.post(api_url, json=request, headers=headers)
    return redirect('GeneratePdfTicket',booking.id)
